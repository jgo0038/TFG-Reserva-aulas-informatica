...
DEBUG = True
# SECRET_KEY = 'claveSecreta' #Creada para encriptar y poder acceder a los diccionarios session.
...
# O365_REDIRECT_URI = 'https://reservaaulas.azurewebsites.net/connect/get_token'
